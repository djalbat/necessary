...
function request(host, uri, parameters, method, body, headers, callback) {
    var url = urlFromHostURIAndParameters(host, uri, parameters), accept = headers[_constants.ACCEPT], contentType = headers[_constants.CONTENT_TYPE], xmlHttpRequest = new XMLHttpRequest();
